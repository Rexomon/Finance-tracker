          ...
          <div class="flex items-center space-x-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div class="relative" id="transaction-dropdown">
                <button
                  @click="showTransactionDropdown = !showTransactionDropdown"
                ...
                >
                  ...
                  <svg
                    ...
                    :class="{ 'rotate-180': showTransactionDropdown }"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <!-- Dropdown Menu -->
                <div
                  v-if="showTransactionDropdown"
                  class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10 border border-gray-200"
                >
                  <div class="py-1">
                    <button
                      @click="handleTransactionAction('add')"
                    ...
                    <button
                      @click="handleTransactionAction('view')"
                      class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left"
                    >
                      <svg
                        class="w-4 h-4 mr-2"
              ...
              <div class="relative" id="category-dropdown">
                ...
                >
                  <div class="py-1">
                    <button
                      @click="handleCategoryAction('add')"
                      class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left"
                    >
                      <svg
                        class="w-4 h-4 mr-2"
                    ...
                    <button
                      @click="handleCategoryAction('view')"
                      class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left"
                    >
                      <svg
                        class="w-4 h-4 mr-2"
              ...
              <div class="relative" id="budget-dropdown">
                <button
                  @click="showBudgetDropdown = !showBudgetDropdown"
                ...
                >
                  ...
                  <svg
                    class="w-4 h-4 ml-2 transition-transform duration-200"
                    :class="{ 'rotate-180': showBudgetDropdown }"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        <div class="bg-white shadow rounded-lg mb-8">
          ...
          <div class="p-6">
            ...
            <div v-else class="space-y-4">
              <div
                v-for="budget in processedBudgets"
                :key="budget._id"
                class="border border-gray-900 rounded-lg p-4"
              >
                <div class="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p class="text-sm text-gray-600">
                      Limit: {{ formatCurrency(budget.originalLimit) }}
                    </p>
                  </div>
                  <div class="text-right">
                    ...
                    <p
                      class="text-sm"
                      :class="getBudgetStatusClass(budget.remaining)"
                    >
                ...
                <p class="text-sm text-gray-600 mt-1">
                  {{
                    Number.isNaN(budget.percentage)
                      ? "0.0"
...
import ExpenseChart from "../components/Dashboard/Charts/ExpenseChart.vue";
import TrendChart from "../components/Dashboard/Charts/TrendChart.vue";
import TransactionModal from "../components/Dashboard/Transaction/TransactionModal.vue";
import TransactionListModal from "../components/Dashboard/Transaction/TransactionListModal.vue";
import CategoryModal from "../components/Dashboard/Category/CategoryModal.vue";
import CategoryListModal from "../components/Dashboard/Category/CategoryListModal.vue";
import BudgetModal from "../components/Dashboard/Budget/BudgetModal.vue";
import BudgetListModal from "../components/Dashboard/Budget/BudgetListModal.vue";
