      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        <div class="space-y-4">
          ...
          <div>
            ...
            <input id="email" v-model="email" type="email" autocomplete="email" required
              ...
              placeholder="Enter your email" @input="handleEmailInput" />
          ...
          <div>
            ...
            <div class="relative">
              <input id="password" v-model="password" :type="showPassword ? 'text' : 'password'"
                ...
                placeholder="Enter your password" @input="handlePasswordInput" />
              <button type="button" tabindex="-1" class="absolute inset-y-0 right-0 pr-3 flex items-center"
                @click="showPassword = !showPassword">
                <svg class="h-5 w-5 text-gray-400 hover:text-gray-300" :class="{ 'text-gray-300': showPassword }"
        ...
        <div class="text-center">
          <p class="text-sm text-gray-300">
            ...
            <router-link to="/signup" class="font-medium text-blue-400 hover:text-blue-300 transition-colors">
              Sign up here
            </router-link>
          </p>
        </div>
